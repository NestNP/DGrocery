                         ...
                         <div class="page-title">
                             <h4>Product Details</h4>
                                 <ol class="breadcrumb m-0">
                                     <li class="breadcrumb-item"><a href="javascript: void(0);">Daily Grocery</a></li>
                                                    ...
                                                    <div class="col-3">
                                                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                            <a class="nav-link active" id="product-1-tab" data-bs-toggle="pill" href="#product-1" role="tab">
                                                                <img src="{{asset('assetsAdmin/images/product/img-7.png')}}" alt="" class="img-fluid mx-auto d-block tab-img rounded">
                                                            </a>
                                                            <a class="nav-link" id="product-2-tab" data-bs-toggle="pill" href="#product-2" role="tab">
                                                                <img src="{{asset('assetsAdmin/images/product/img-8.png')}}" alt="" class="img-fluid mx-auto d-block tab-img rounded">
                                                            </a>
                                                            <a class="nav-link" id="product-3-tab" data-bs-toggle="pill" href="#product-3" role="tab">
                                                                <img src="{{asset('assetsAdmin/images/product/img-9.png')}}" alt="" class="img-fluid mx-auto d-block tab-img rounded">
                                                            </a>
                                                            <a class="nav-link" id="product-4-tab" data-bs-toggle="pill" href="#product-4" role="tab">
                                                                <img src="{{asset('assetsAdmin/images/product/img-11.png')}}" alt="" class="img-fluid mx-auto d-block tab-img rounded">
                                                            </a>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="tab-content" id="v-pills-tabContent">
                                                            <div class="tab-pane fade show active" id="product-1" role="tabpanel">
                                                                <div class="product-img">
                                                                    <img src="{{asset('assetsAdmin/images/product/img-7.png')}}" alt="" class="img-fluid mx-auto d-block" data-zoom="assets/images/product/img-1.png')}}">
                                                                </div>
                                                            </div>
                                                            <div class="tab-pane fade" id="product-2" role="tabpanel">
                                                                <div class="product-img">
                                                                    <img src="{{asset('assetsAdmin/images/product/img-8.png')}}" alt="" class="img-fluid mx-auto d-block">
                                                                </div>
                                                            </div>
                                                            <div class="tab-pane fade" id="product-3" role="tabpanel">
                                                                <div class="product-img">
                                                                    <img src="{{asset('assetsAdmin/images/product/img-9.png')}}" alt="" class="img-fluid mx-auto d-block">
                                                                </div>
                                                            </div>
                                                            <div class="tab-pane fade" id="product-4" role="tabpanel">
                                                                <div class="product-img">
                                                                    <img src="{{asset('assetsAdmin/images/product/img-11.png')}}" alt="" class="img-fluid mx-auto d-block">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="product-color mt-3">
                                                            ...
                                                            <a href="#" class="active">
                                                                <div class="product-color-item">
                                                                    <img src="{{asset('assetsAdmin/images/product/img-7.png')}}" alt="" class="avatar-md">
                                                                </div>
                                                                <p>Blue</p>
                                                            </a>
                                                            <a href="#">
                                                                <div class="product-color-item">
                                                                    <img src="{{asset('assetsAdmin/images/product/img-8.png')}}" alt="" class="avatar-md">
                                                                </div>
                                                                <p>Cyan</p>
                                                            </a>
                                                            <a href="#">
                                                                <div class="product-color-item">
                                                                    <img src="{{asset('assetsAdmin/images/product/img-9.png')}}" alt="" class="avatar-md">
                                                                </div>
                                                                <p>Green</p>
                                                            </a>
                                                        </div>
