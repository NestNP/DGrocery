    ...
    <script src="{{asset ('assetsAdmin/libs/admin-resources/jquery.vectormap/maps/jquery-jvectormap-world-mill-en.js')}}"></script>
...
<script src="{{asset('assets/libs/jquery/jquery.min.js')}}"></script>
     ...
     <script src="{{asset('assetsAdmin/js/pages/ecommerce-cart.init.js')}}"></script>
