 ...
 <footer class="site-footer footer-opt-1">
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 col-lg-3 col-xs-6 col">
                    ...
                    <table class="address">
                        ...
                        <tr>
                            <td><b>Email:</b></td>
                            <td>info@dailygrocery.com.np</td>
                        </tr>
                    </table>
                </div>
                ...
                width: 50vw;">
                    ...
                    <div class="block-social">
                        ...
                        <div class="block-content">
                            <a href="https://www.facebook.com/dailygrocerynepal" class="sh-facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                            <a href="https://www.instagram.com/dgmart_official/"><i class="fa fa-instagram" aria-hidden="true"></i></a>
        ...
        <div class="copyright">
            Copyright © DailyGrocery. All Rights Reserved. Designed by <a href="https://html.kutethemes.com/" target="_blank">Kutethemes.com</a>
        </div>
...
<!-- fancybox -->
<script src="{{asset ('assets/js/fancybox/source/jquery.fancybox.pack.js') }}"></script>
<script src="{{asset ('assets/js/fancybox/source/helpers/jquery.fancybox-media.js') }}"></script>
<script src="{{asset ('assets/js/fancybox/source/helpers/jquery.fancybox-thumbs.js') }}"></script>

<!-- arcticmodal -->
<script src="{{asset ('assets/js/arcticmodal/jquery.arcticmodal.js') }}"></script>
