                ...
                <ul class="row list-wishlist">
                    <li class="col-sm-3">
                        <div class="product-img">
                            <a href="#"><img alt="Product" src="{{asset('assets/images/media/detail/wishlist1.jpg')}}"></a>
                        </div>
                    ...
                    <li class="col-sm-3">
                        <div class="product-img">
                            <a href="#"><img alt="Product" src="{{asset('assets/images/media/detail/wishlist2.jpg')}}"></a>
                        </div>
                        <h5 class="product-name">
                            <a href="#">Adipiscing aliquet sed in lacus, Liqui-gels 24</a>
                        </h5>
                    ...
                    <li class="col-sm-3">
                        <div class="product-img">
                            <a href="#"><img alt="Product" src="{{asset('assets/images/media/detail/wishlist3.jpg')}}"></a>
                        </div>
                        <h5 class="product-name">
                            <a href="#">Adipiscing aliquet sed in lacus, Liqui-gels 24</a>
                        </h5>
                    ...
                    <li class="col-sm-3">
                        <div class="product-img">
                            <a href="#"><img alt="Product" src="{{asset('assets/images/media/detail/wishlist4.png')}}"></a>
                        </div>
                        <h5 class="product-name">
                            <a href="#">Adipiscing aliquet sed in lacus, Liqui-gels 24</a>
                        </h5>
                    ...
                    <li class="col-sm-3">
                        <div class="product-img">
                            <a href="#"><img alt="Product" src="{{asset('assets/images/media/detail/wishlist5.jpg')}}"></a>
                        </div>
                        <h5 class="product-name">
                            <a href="#">Adipiscing aliquet sed in lacus, Liqui-gels 24</a>
                        </h5>
                    ...
                    <li class="col-sm-3">
                        <div class="product-img">
                            <a href="#"><img alt="Product" src="{{asset('assets/images/media/detail/wishlist6.jpg')}}"></a>
                        </div>
                        <h5 class="product-name">
                            <a href="#">Adipiscing aliquet sed in lacus, Liqui-gels 24</a>
                        </h5>
                    ...
                    <li class="col-sm-3">
                        <div class="product-img">
                            <a href="#"><img alt="Product" src="{{asset('assets/images/media/detail/wishlist7.jpg')}}"></a>
                        </div>
                        <h5 class="product-name">
                            <a href="#">Adipiscing aliquet sed in lacus, Liqui-gels 24</a>
                        </h5>
                    ...
                    <li class="col-sm-3">
                        <div class="product-img">
                            <a href="#"><img alt="Product" src="{{asset('assets/images/media/detail/wishlist8.jpg')}}"></a>
                        </div>
                        <h5 class="product-name">
                            <a href="#">Adipiscing aliquet sed in lacus, Liqui-gels 24</a>
                        </h5>
                        ...
                        "992":{"items":1}
                            ...
                            <div class="item">
                                <div class="product-item product-item-opt-1">
                                    <div class="product-item-info">
                                        <div class="product-item-photo">
                                            <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/images/media/detail/best1.jpg')}}"></a>
                                        </div>
                                ...
                                <div class="product-item product-item-opt-1">
                                    <div class="product-item-info">
                                        <div class="product-item-photo">
                                            <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/images/media/detail/best2.jpg')}}"></a>
                                        </div>
                                        <div class="product-item-detail">
                                ...
                                <div class="product-item product-item-opt-1">
                                    <div class="product-item-info">
                                        <div class="product-item-photo">
                                            <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/images/media/detail/best3.jpg')}}"></a>
                                        </div>
                                        <div class="product-item-detail">
                    ...
                    <div class="block-content">
                        <div class="owl-carousel"
                            ...
                            <div class="item " >
                               ...
                               <div class="avata">
                                    <img src="{{asset('assets/images/media/avata.jpg')}}" alt="avat">
                               </div>
                               <div class="des">
